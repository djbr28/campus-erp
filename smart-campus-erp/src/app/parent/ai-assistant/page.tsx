// ============================================================
// Smart Campus ERP — Parent AI Assistant
// ============================================================
"use client";
...
const parentQuestions = [
  ...
  "Show recent campus announcements",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="page-subtitle">
            Ask about your child&apos;s attendance, fees, announcements, and campus safety.
          </p>
        </div>
      </div>
          ...
          {messages.length === 0 && (
            <div className="h-full flex flex-col items-center justify-center text-center p-6">
              ...
              <p className="text-xs text-white/50 max-w-sm mt-1 font-light">
                Ask about your child&apos;s attendance, fees, announcements, or campus safety.
              </p>
            </div>
          )}
        ...
        <div className="p-3 sm:p-4 border-t border-white/10 bg-[#141414]">
          ...
          >
            <input
              ...
              placeholder="Ask about your child's attendance, fees, announcements…"
