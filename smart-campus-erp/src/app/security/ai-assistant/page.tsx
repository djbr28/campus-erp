// ============================================================
// Smart Campus ERP — Security AI Assistant
// ============================================================
"use client";
...
const securityQuestions = [
  ...
  "What's the incident count today?",
  "Which locations have the most incidents?",
];

export default function SecurityAIAssistantPage() {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="page-subtitle">
            Query campus incidents, safety alerts, and security records using natural language.
          </p>
        </div>
      </div>
          ...
          {messages.length === 0 && (
            <div className="h-full flex flex-col items-center justify-center text-center p-6">
              ...
              <p className="text-xs text-white/50 max-w-sm mt-1 font-light">
                Ask about campus incidents, safety alerts, or security records.
              </p>
            </div>
          )}
        ...
        <div className="p-3 sm:p-4 border-t border-white/10 bg-[#141414]">
          ...
          >
            <input
              ...
              placeholder="Ask about incidents, safety alerts, security records…"
