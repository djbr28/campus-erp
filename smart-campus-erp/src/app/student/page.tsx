// ============================================================
// Smart Campus ERP — Student Dashboard (Editorial Aesthetic)
// ============================================================
"use client";
    ...
    <div className="space-y-8 animate-fade-in text-[#f4f6d6]">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/10 text-white/90 text-xs font-semibold mb-3 border border-white/15">
              <span>Academic Year {currentStudent.year}</span>
              <span>•</span>
            ...
            <p className="mt-2 text-white/70 text-xs sm:text-sm font-light">
              Student ID: <span className="font-mono font-bold text-[#f4f6d6]">{currentStudent.id}</span> · Current GPA: <span className="font-bold text-[#bf783e]">{currentStudent.gpa}</span>
            </p>
          </div>
      ...
      <div className="grid-4">
        <StatCard
          ...
          change={currentStudent.attendancePct >= 85 ? "Good" : "Warning"}
          trend={currentStudent.attendancePct >= 85 ? "up" : "down"}
        ...
        <div className="lg:col-span-2 card-flat p-6 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-5">
              <div>
                <h2 className="section-heading mb-0">Today&apos;s Lecture Schedule</h2>
            ...
            <div className="space-y-3">
              {studentAttendance.slice(0, 4).map((a) => (
                <div
                  key={a.code}
      ...
      {/* Emergency Immediate Action Bar */}
      <Link
        href="/student/report-incident"
