// ============================================================
// Smart Campus ERP — Student AI Assistant
// ============================================================
"use client";

import { useEffect, useRef, useState } from "react";
import { aiInitialMessages, aiExampleQuestions } from "@/lib/mock-data-step2";
import type { ChatMessage } from "@/types";
import { SparklesIcon } from "@/components/ui/Icons";

const studentQuestions = [
  "What's my current attendance percentage?",
  "When is the next fee payment deadline?",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="page-subtitle">
            Ask about your attendance, fees, classes, grades, and campus announcements.
          </p>
        </div>
      </div>
          ...
          {messages.length === 0 && (
            <div className="h-full flex flex-col items-center justify-center text-center p-6">
              ...
              <p className="text-xs text-white/50 max-w-sm mt-1 font-light">
                Ask about your attendance, fees, classes, or campus announcements.
              </p>
            </div>
          )}
        ...
        <div className="p-3 sm:p-4 border-t border-white/10 bg-[#141414]">
          ...
          >
            <input
              ...
              placeholder="Ask about your attendance, fees, classes…"
