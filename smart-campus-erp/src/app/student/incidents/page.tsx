// ============================================================
// Smart Campus ERP — Student Incidents View (Live Supabase + Fallback)
// ============================================================
"use client";
  ...
  useEffect(() => {
    async function loadIncidents() {
      try {
        ...
        if (error) {
          console.warn("[StudentIncidents] Supabase query error, using defaults:", error.message);
        ...
        console.warn("[StudentIncidents] Exception loading incidents:", err);
      } finally {
        setIsLoading(false);
      }
    }
